...
'''Calculate possible exp_cov for velvetg

Arguments:
    fastq file: The fastq file
    genome size: An int expressing the genome size
Return:
    Prints the exp_cov to stdout.
'''

# NOTE: THIS IS --NOWHERE-- NEAR READY FOR USE!!
